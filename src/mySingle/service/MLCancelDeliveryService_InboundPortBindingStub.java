/**
 * MLCancelDeliveryService_InboundPortBindingStub.java
 *
...
public class MLCancelDeliveryService_InboundPortBindingStub extends org.apache.axis.client.Stub implements samsung.esb.mail.service.MLCancelDeliveryService {
    ...
    private static void _initOperationDesc1(){
        ...
        param.setNillable(true);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "addressForCancel"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://samsung/esb/mail/vo", "ArrayOfString"), java.lang.String[].class, false, false);
        param.setItemQName(new javax.xml.namespace.QName("", "mailLists"));
        param.setNillable(true);
        oper.addParameter(param);
        ...
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://samsung/esb/mail/service", "cancelMISMailByRecipient_esbFaultVO"),
    ...
    public MLCancelDeliveryService_InboundPortBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public MLCancelDeliveryService_InboundPortBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public MLCancelDeliveryService_InboundPortBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName2 = new javax.xml.namespace.QName("", "mailLists");
    ...
    public java.lang.String cancelMISMailByRecipient(samsung.esb.common.vo.ESBAuthVO esbAuthVO, java.lang.String mtrKey, java.lang.String[] addressForCancel, samsung.esb.mail.vo.ResourceCSVO resourceCSVO) throws java.rmi.RemoteException, samsung.esb.common.vo.ESBFaultVO {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://samsung/esb/mail/service", "cancelMISMailByRecipient"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {esbAuthVO, mtrKey, addressForCancel, resourceCSVO});
