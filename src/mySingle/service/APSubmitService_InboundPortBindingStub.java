/**
 * APSubmitService_InboundPortBindingStub.java
 *
...
public class APSubmitService_InboundPortBindingStub extends org.apache.axis.client.Stub implements samsung.esb.approval.service.APSubmitService {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "startProcessWSVO"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://samsung/esb/approval/vo", "StartProcessWSVO"), samsung.esb.approval.vo.StartProcessWSVO.class, false, false);
        param.setNillable(true);
        oper.addParameter(param);
        ...
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://samsung/esb/approval/service", "submitApproval_esbFaultVO"),
    ...
    public APSubmitService_InboundPortBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public APSubmitService_InboundPortBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public APSubmitService_InboundPortBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://samsung/esb/approval/vo", "StartProcessWSVO");
            cachedSerQNames.add(qName);
            cls = samsung.esb.approval.vo.StartProcessWSVO.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public java.lang.String submitApproval(samsung.esb.common.vo.ESBAuthVO esbAuthVO, samsung.esb.approval.vo.StartProcessWSVO startProcessWSVO) throws java.rmi.RemoteException, samsung.esb.common.vo.ESBFaultVO {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://samsung/esb/approval/service", "submitApproval"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {esbAuthVO, startProcessWSVO});
